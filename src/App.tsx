   ...
   <div>
    ...
    구매해주셔서 감사합니다.</p>   
      ...
      <Narrative content={<div>
        <p>B씨는 와일드카드부터 준플레이오프, 플레이오프, 한국시리즈까지 포스트시즌 전 경기에 걸쳐 암표를 등록했습니다. 총 수량은 182장으로, 거래 금액은 7167만1,800원에 달했습니다.</p>
        <p>C씨 역시 전 경기에서 4725만9,200원 상당의 티켓 69장을 등록했습니다.</p>
        <p>특히 C씨는 야구 티켓뿐 아니라 아이돌 콘서트 티켓도 거래하며, 추가로 408만7,000원을 벌어들였습니다.</p>        
      </div>}/>
