...
<p>규정에 따르면, 티켓을 <strong>현장에서 웃돈을 받고 되팔거나, 1) 상습성 2) 영업성 3) 매크로 사용을 전제로 부정 판매를 한 경우에만 처벌</strong>할 수 있습니다. 

<br></br>그러나 두 법률 모두 ‘행위’만을 규정하고 있어, ‘암표’의 정의가 법률적 해석에 따라 달라질 수 있고 충족 여부를 입증하기도 쉽지 않습니다. </p>
...
이제 다시 잘못된 방향을 돌려, 티켓 공정 소비를 점검해야 할 때입니다. <br></br>

<strong>정말 가고 싶은 사람들</strong>에게 티켓이 돌아가는 시장**.** 그 단순하고 상식적인 원칙을 회복하기 위한 실효성 있는 대책이 필요합니다. </p>
</div>} />
